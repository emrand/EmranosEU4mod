...
NCountry = {
	...
	ABANDON_IDEAGROUP_REFUND = 0.15,				-- The part of the idea group spent that will be refunded upon abandonment.
...
NMilitary = {
	...
	LOOT_DEVASTATION_IMPACT = 5,						-- how much devastation full loot impacts
